...
<script type="text/javascript">
    $(document).ready(function(){
        $('button.remove').click(function() {
            $.post("/entity/consumer/delete/" + $(this).attr('consumerId'),
                    {},
        ...
        $('button.edit').click(function() {
            $(location).attr('href', "/entity/consumer/edit/" + $(this).attr('consumerId'))
        });
    });
...
<div id="content">
    ...
    <div class="collapse" id="collapseFilter">
        <fieldset>
            <form name="filterForm" role="form" method="get" action="/entity/consumer/filter">
                <div class="form-group">
                    <label>Good:</label>
    ...
    <table class="table table-bordered table-striped">
        <tbody>
            <#list consumers as consumer>
                <tr>
                    <td>${consumer.name}</td>
                    <td><button type="button" class="btn btn-danger remove" consumerId="${consumer.id}">delete</button></td>
                    <td><button type="button" class="btn btn-info edit" consumerId="${consumer.id} ">edit</button></td>
                </tr>
            </#list>
        </tbody>
        <thead>
